...
export const getStreamYearId = (cs: ClassStream): string => {
  ...
  if (cs.settings?.termYearInfo) {
    const y = cs.settings.termYearInfo.split(' ΓÇö ')[0] || cs.settings.termYearInfo.split(' - ')[0];
...
function buildDemoSnapshot(): {
  ...
  const settings2526 = {
    ...
    termYearInfo: '2025/2026 ΓÇö Term 3',
  ...
  const schools: School[] = [
    {
      ...
      address: 'P. O. Box DS 75, Dansoman ΓÇô Accra',
  ...
  const classes: ClassStream[] = [
    {
      ...
      settings: {
        ...
        termYearInfo: '2026/2027 ΓÇö Term 1',
    ...
    },
    {
      ...
      settings: {
        ...DEFAULT_CLASS_SETTINGS(),
        teacherName: 'Akosua Mensah',
        termYearInfo: '2023/2024 ΓÇö Term 3',
      },
    },
  ];
  ...
  pushSummary(
    ...
    false,
    null,
    { generalComment: 'Draft ΓÇö pending finalization' }
  );
  for (const code of ['ENG', 'MATH', 'SCI']) {
